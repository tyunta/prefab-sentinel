...
- 統合テスト: `validate integration-tests --unity-command ... --unity-project-path ...` で 66 件の bridge ops (open-mode set/insert/remove, create-mode prefab/material/scene, variant override E2E, handle-based ObjectReference, remove_component, rename_object, reparent, find_component, add_component エッジケース, 追加 value_kind, エラーパス, 境界テスト) を Unity batchmode で検証
