...
- 現在の per-concern token inventory（test 用、追加・削除時に同期）:
  - `UnityEditorControlBridge`: Acceptance / AnimationClip / AssetDelete / AssetOps / AssetOps.Create / AssetOps.Move / BlendShape / BridgeDeploy / CameraView / CompileBarrier / Components / ConsoleCapture / EditorState / Geometry / GeometryContributors / Helpers / Hierarchy / InspectorSurface / InspectorSurface.Payload / InspectorSurface.Scene / MaterialBatch / MaterialQuery / MaterialWrite / Menu / MenuScriptWatch / PrefabStage / Properties / PropertyObjectReference / PropertyWrite / RendererFramingBounds / RunScriptAsync / RunScriptCompile / SaveInstantiate / Screenshot / Screenshot.TargetCapture / Screenshot.TargetCapture.WorldSpaceUi / SerializedProperty / SerializedProperty.ObjectReference / SerializedProperty.Payload / SerializedProperty.Target / SerializedProperty.Traversal / SerializedProperty.Write / UdonSharpAddComponent / UdonSharpArrayWrite / UdonSharpFieldWrite / UdonSharpInvocation / UdonSharpListenerWiring / UiElement
