...
- 統合テスト: `validate integration-tests --unity-command ... --unity-project-path ...` で 54 件の bridge ops (open-mode set/insert/remove, create-mode prefab/material/scene, variant override E2E, handle-based ObjectReference, remove_component, 追加 value_kind, エラーパス) を Unity batchmode で検証
