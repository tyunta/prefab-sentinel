...
ソースバージョン: kawaiiposing 3.0.5 + posingsystem 3.0.6、2.2.5 と差分検証済み
...
**GUID 安定性**: v3.0.x と v2.2.5 で全 4 コンポーネントの GUID が一致。パッケージバージョン間で GUID は安定している。
...
- **PosingSystem (v2.2.5)**: `isPosingSystemLicensed` フィールドあり (v3.0.x で削除)
