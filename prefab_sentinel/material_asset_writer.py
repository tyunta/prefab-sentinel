...
from prefab_sentinel.material_asset_inspector import (
    find_material_property,
    list_material_property_names,
)
...
def write_material_property(
    ...
    *,
    ...
    category, before, section_name = find_material_property(text, property_name)
    if category is None:
        all_names = list_material_property_names(text)
    ...
    verify_cat, _verify_val, _ = find_material_property(new_text, property_name)
