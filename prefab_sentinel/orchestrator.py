    ...
    def inspect_wiring(
        ...
        *,
        ...
        Args:
            ...
            summary_only: When ``True``, return only the four diagnostic
                counts and suppress the per-component slice and the
                per-reference diagnostic list (issue #227).
            script_filter: When non-empty, narrow the merged component
    ...
    def validate_refs(
        ...
        *,
        ...
        Args:
            ...
            refresh_guid_index: When ``True``, invalidate the resolver's
                GUID index cache before scanning so a freshly created
                asset is observable on the same call (issue #229).
