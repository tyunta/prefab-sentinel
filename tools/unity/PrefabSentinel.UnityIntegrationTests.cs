...
{
    /// <summary>
    /// Integration tests for <see cref="UnityPatchBridge"/> executed inside
    /// the resident Editor Bridge.  Invoked through the
    /// ``run_integration_tests`` action with an output-path argument that
    /// names the JSON results file.  Each case creates transient fixture
    /// assets, exercises set / insert_array_element / remove_array_element
